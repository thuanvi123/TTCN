...
class ShopCategoryController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        $item->c_slug = $input['c_slug'] ? $this->slugify($input['c_slug']) : $this->slugify($input['c_slug']);
        $item->c_avatar = isset($input['c_avatar']) ? $input['c_avatar'] : '';
        $item->c_icon = isset($input['c_icon']) ? $input['c_icon'] : '';
        $item->c_title_seo = isset($input['c_title_seo']) ? $input['c_title_seo'] : '';
        $item->c_description_seo = isset($input['c_description_seo']) ? $input['c_description_seo'] : '';
